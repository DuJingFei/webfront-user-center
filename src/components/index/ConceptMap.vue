<template>
    <div class="concept-map">
       <el-popover
            ...
            <a class="hya-solar hya-solar-inverter icon-hand" slot="reference"></a>
       </el-popover>
       ...
       <el-popover
            ...
            <a class="icon-hand hya-solar hya-remote-system" slot="reference"></a>
       </el-popover>
...
.concept-map {
   width: 1000px;
   height: 514px;
   background-image: url('../../assets/images/priory.jpg');
